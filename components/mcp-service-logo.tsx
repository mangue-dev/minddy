...
const marks: Record<string, { path: string; hex: string }> = {
  notion: siNotion,
  linear: siLinear,
  "google-gmail": siGmail,
  ...
  vercel: siVercel,
  stripe: siStripe,
  // Simple Icons v11 (CC0): https://github.com/simple-icons/simple-icons/tree/11.15.0
  slack: {
...
/** Local provider marks avoid requests to third-party logo services. */
export function McpServiceLogo({
  ...
  return (
    ...
    >
      <path d={mark.path} fill={monochrome ? "currentColor" : `#${mark.hex}`} />
    </svg>
  );
}
