 ...
 *
 * Le panneau est celui des réglages du projet, tel quel ; le dialog n'ajoute
 * que ce qui n'existe que là : dans quel projet importer (les réglages le
 * savent déjà) et le renvoi vers ces mêmes réglages pour plus tard.
 *
 * `initialFile` est le CSV lâché sur la carte d'onboarding : le dialog s'ouvre
 * alors directement sur l'aperçu.
 */
