...
import { AgentWorkFigure } from "./workspace-figures";
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <FeatureDisclosure title={t("workflow_review_title")} className={`min-h-[460px] lg:col-span-2 ${CARD_TONES.sage}`}
            ...
            <div className="flex h-full flex-col px-6 pt-6 pb-20 sm:px-8 sm:pt-8">
              ...
              <div className="mt-auto pt-6">
                <ScreenshotSlot id="workflowPr" expandable focused sizes="(min-width: 1024px) 700px, 100vw" className="mx-auto w-full max-w-lg rounded-xl shadow-sm" />
              </div>
            </div>
          </FeatureDisclosure>
