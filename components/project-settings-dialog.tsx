...
export function ProjectSettingsDialog({
  ...
  const { user } = useAuth();
  const { updateProject, deleteProject, refetch } = useProjects();
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>Nom, clé et membres.</DialogDescription>
          </DialogHeader>
          ...
          <Tabs defaultValue="general">
            ...
            <TabsContent value="members" className="pt-4">
              <ProjectMembers projectId={project.id} enabled={open} />
            </TabsContent>
          </Tabs>
        </DialogContent>
      </Dialog>
