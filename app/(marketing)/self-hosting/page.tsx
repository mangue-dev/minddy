...
export default async function SelfHostingPage() {
  ...
  const guideCopy = {
    ...
    serviceGithubTitle: t("serviceGithubTitle"),
    serviceGithubBody: t("serviceGithubBody"),
    serviceGithubSetup: t("serviceGithubSetup"),
    serviceGitlabTitle: t("serviceGitlabTitle"),
    serviceGitlabBody: t("serviceGitlabBody"),
    serviceGitlabSetup: t("serviceGitlabSetup"),
