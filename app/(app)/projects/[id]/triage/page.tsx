      ...
      >
        <DialogContent className="sm:max-w-md">
          ...
          <MentionTextarea
            ...
            autoFocus
            includeNumo
            className="w-full rounded-lg border border-border bg-transparent px-3 py-2 text-sm outline-none [&:empty]:before:text-muted-foreground/60 focus-visible:border-ring"
