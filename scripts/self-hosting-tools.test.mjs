...
import { configFindings, disabledCapabilities, parseArgs as parseDoctorArgs, redact } from "./self-hosting-doctor.mjs";
...
test("the installer creates a readable self-hosted configuration with integrations disabled", () => {
  ...
  const rendered = renderEnvironment("MINDDY_HOST=tickets.example.com\nADMIN_EMAILS=ops@example.com\nMINDDY_MANAGED_AI=1\nMINDDY_MANAGED_BILLING=1\nAGENT_EXECUTION_BACKEND=cloud\n", values);
