...
export function appendMissingEnv(file, values) {
  ...
  // `mode` applies only when writeFileSync creates the file. Tighten an
  // existing file before adding secrets so they are never written through an
  // inherited group/world-readable mode.
