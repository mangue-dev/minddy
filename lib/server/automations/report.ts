...
const STOP_REASONS: Record<Locale, Record<string, string>> = {
  ...
  de: {
    ...
    noModelForProvider: "in den Kontoeinstellungen kein Code-Agent-Modell für diesen Anbieter konfiguriert ist",
  ...
  "pt-BR": {
    ...
    noModelForProvider: "nenhum modelo de agente de código está configurado para este provedor nas definições da conta",
  ...
  it: {
    ...
    noModelForProvider: "nelle impostazioni dell’account non è configurato alcun modello di agente di codice per questo provider",
  ...
  es: {
    ...
    noModelForProvider: "no hay ningún modelo de agente de código configurado para este proveedor en los ajustes de la cuenta",
