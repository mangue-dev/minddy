...
- add_feedback_comment { body } — leave a SHORT team-only triage note (two or three sentences or a few one-line bullets, 1000 characters at most, no headings). It is never shown on the public board.
